...
cxt.fillStyle = (micolor);
cxt.beginPath();
cxt.arc(escala * 50, escala * 50, escala * 40, 0, Math.PI * 2, false);
cxt.closePath;
cxt.fill();
...
//Dibujo el icono M�sica

var c = document.getElementById("iconomusica");
var cxt = c.getContext("2d");
...
cxt.fillStyle = (mitercercolor);
cxt.beginPath();
cxt.arc(escala * 50, escala * 50, escala * 10, 0, Math.PI * 2, true);
cxt.closePath;
cxt.fill();